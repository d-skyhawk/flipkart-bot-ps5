    ...
    if len(chk_list_urls) < 1:
        ...
        while True:
            for index, url in enumerate(chk_list_urls):
                ...
                try:
                    if soup.find('button', class_ = '_2KpZ6l _2uS5ZX _2Dfasx').text == 'NOTIFY ME':
                    ...
                    try:
                        if soup.find('button', class_ = '_2KpZ6l _2U9uOA _3v1-ww').text == ' ADD TO CART':
                            ...
                            tok = os.environ.get("TELEGRAM_APP_API_ID") + ":" + os.environ.get("TELEGRAM_APP_API_HASH")
                            app = Client(
                                "tg_ac",
                                api_id=os.environ.get("TELEGRAM_APP_API_ID"),
                                api_hash=os.environ.get("TELEGRAM_APP_API_HASH"),
                                bot_token="5114134536:AAHZTrbJj_0WF8zrce4zvteDjv7jrQxf9Ec"
                            )
